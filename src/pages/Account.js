...
function CardDetailsModal({ card, onClose, onUpdate, onDelete, formatCardNumber, formatFullCardNumber, formatExpirationDate, getCardType }) {
    return (
        <div className="modal-overlay" onClick={onClose}>
            <div className="card-modal" onClick={(e) => e.stopPropagation()}>
                ...
                {/* Only Update and Delete buttons - Close button removed */}
